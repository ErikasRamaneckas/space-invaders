...
import { CANVAS_WIDTH, CANVAS_HEIGHT, BULLET_WIDTH, BULLET_HEIGHT, } from './consts.js';
export default class PlayerController {
    ...
    shoot() {
        if (this.spacePressed &&
            ...
            const newBullet = new PlayerBullet(this.player.x + this.player.width / 2 - BULLET_WIDTH / 2, CANVAS_HEIGHT - this.player.height - BULLET_HEIGHT);
